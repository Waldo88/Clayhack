...
QUICK_ATTACK_MOVE EQU $F9
AQUA_JET_MOVE     EQU $FA
ICE_SHARD_MOVE    EQU $FB
SHADOW_SNEAK_MOVE EQU $FC
BULLET_PUNCH_MOVE EQU $FD
MACH_PUNCH_MOVE   EQU $FE
EXTREMESPEED_MOVE EQU $FF